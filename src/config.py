...
# Giữ output tiếng Việt/emoji chạy được trên Windows console dùng code page cũ.
...
# Backward compatible: older .env files may still provide GOOGLE_API_KEY.
...
def validate() -> bool:
    ...
    if PROVIDER == "openai" and not OPENAI_API_KEY:
        ...
        missing.append("GOOGLE_API_KEY hoặc GOOGLE_API_KEY_1")
