...
PROMPT_V1_NAME = "dao-duc-manh-day22-rag-prompt-v1"
PROMPT_V2_NAME = "dao-duc-manh-day22-rag-prompt-v2"
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        ...
        if "Nothing to commit" in str(e):
            print("ℹ️  V1 đã có phiên bản mới nhất trên Hub")
        else:
            print(f"⚠️  V1 lỗi: {e}")
    ...
    try:
        ...
        if "Nothing to commit" in str(e):
            print("ℹ️  V2 đã có phiên bản mới nhất trên Hub")
        else:
            print(f"⚠️  V2 lỗi: {e}")
